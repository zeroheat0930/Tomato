...
import 'package:zeroheatproject/data/chatroom_model.dart';
import 'package:zeroheatproject/data/item_model.dart';
import 'package:zeroheatproject/data/user_model.dart';
import 'package:zeroheatproject/repo/chat_service.dart';
import 'package:zeroheatproject/repo/item_service.dart';
import 'package:zeroheatproject/router/locations.dart';
import 'package:zeroheatproject/screens/item/similar_item.dart';
...
import 'package:zeroheatproject/utils/time_calculation.dart';
...
class _ItemDetailScreenState extends State<ItemDetailScreen> {
  ...
  void _goToChatroom(ItemModel itemModel, UserModel userModel) async {
    ...
    BeamState beamState = Beamer.of(context).currentConfiguration! as BeamState;
